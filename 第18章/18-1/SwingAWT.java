...
public class SwingAWT
{
	...
	//定义一个按钮,并为之指定图标
	Icon okIcon = new ImageIcon("tu/ok.png");
	JButton ok = new JButton("确认" , okIcon);
	//定义一个单选按钮，初始处于选中状态
	JRadioButton nan = new JRadioButton("男" , true);
	//定义一个单按钮，初始处于没有选中状态
	JRadioButton fenan = new JRadioButton("女" , false);
	//定义一个ButtonGroup，用于将上面两个JRadioButton组合在一起
	ButtonGroup bg = new ButtonGroup();
	//定义一个复选框，初始处于没有选中状态。
	JCheckBox married = new JCheckBox("婚否？" , false);
	...
	//创建“新建”菜单项，并为之指定图标
	Icon newIcon = new ImageIcon("tu/new.png");
	JMenuItem newItem = new JMenuItem("新建" , newIcon);
	//创建“保存”菜单项，并为之指定图标
	Icon saveIcon = new ImageIcon("tu/save.png");
	JMenuItem saveItem = new JMenuItem("保存" , saveIcon);
	//创建“退出”菜单项，并为之指定图标
	Icon exitIcon = new ImageIcon("tu/exit.png");
	JMenuItem exitItem = new JMenuItem("退出" , exitIcon);	
	JCheckBoxMenuItem autoWrap = new JCheckBoxMenuItem("换行");
	//创建“复制”菜单项，并为之指定图标
	JMenuItem copyItem = new JMenuItem("复制" , new ImageIcon("tu/copy.png"));
	//创建“粘贴”菜单项，并为之指定图标
	JMenuItem pasteItem = new JMenuItem("粘贴" , new ImageIcon("tu/paste.png"));
	...
	public void init()
	{
		...
		edit.add(copyItem);
		edit.add(pasteItem);
		commentItem.setToolTipText("使用注释起来！");
		//为format菜单添加菜单项
